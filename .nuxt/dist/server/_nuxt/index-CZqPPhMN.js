import { ref, mergeProps, useSSRContext, watch } from "vue";
import { ssrRenderAttrs, ssrRenderClass, ssrRenderAttr, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderList, ssrRenderStyle, ssrRenderComponent } from "vue/server-renderer";
import { _ as _export_sfc } from "../server.mjs";
import "C:/Users/ARSY/slr-engine/node_modules/ofetch/dist/node.mjs";
import "#internal/nuxt/paths";
import "C:/Users/ARSY/slr-engine/node_modules/nuxt/node_modules/hookable/dist/index.mjs";
import "C:/Users/ARSY/slr-engine/node_modules/unctx/dist/index.mjs";
import "C:/Users/ARSY/slr-engine/node_modules/h3/dist/index.mjs";
import "vue-router";
import "C:/Users/ARSY/slr-engine/node_modules/defu/dist/defu.mjs";
import "C:/Users/ARSY/slr-engine/node_modules/ufo/dist/index.mjs";
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!previewUrl.value) {
        _push(`<div class="dropzone-placeholder" data-v-ff6baf2f><div class="animated-cloud-icon" data-v-ff6baf2f>📤</div><p class="main-upload-text" data-v-ff6baf2f>Tarik gambar ke sini atau <span class="browse-link" data-v-ff6baf2f>Cari Berkas</span></p><span class="sub-upload-text" data-v-ff6baf2f>Mendukung format PNG, JPG, JPEG dari chart PRISMA</span></div>`);
      } else {
        _push(`<div class="dropzone-preview" data-v-ff6baf2f><img${ssrRenderAttr("src", previewUrl.value)} class="img-preview-smooth" data-v-ff6baf2f><div class="file-info-overlay" data-v-ff6baf2f><span class="file-name-text" data-v-ff6baf2f>📄 ${ssrInterpolate(selectedFile.value.name)}</span><span class="file-size-badge" data-v-ff6baf2f>${ssrInterpolate((selectedFile.value.size / 1024).toFixed(1))} KB</span></div></div>`);
      }
      ...
      if (isProcessing.value) {
        _push(`<span data-v-ff6baf2f>🤖 Menjalankan Ekstraksi Vision AI...</span>`);
      } else {
        _push(`<span data-v-ff6baf2f>🚀 Jalankan Protokol Sintesis AI</span>`);
      }
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "biblio-container" }, _attrs))} data-v-e9255cb5><div class="panel-header-badge-blue" data-v-e9255cb5>STEP 2</div><h3 class="section-title" data-v-e9255cb5>📊 Advanced Literature Synthesis &amp; Aggregator Workspace</h3><p class="section-desc" data-v-e9255cb5>Pilih arsitektur analisis di bawah ini untuk memetakan keterhubungan dokumen riset, ekstraksi parameter mikro, atau penentuan peta tematis strategis jurnal.</p><div class="logic-tabs" data-v-e9255cb5><button class="${ssrRenderClass([{ active: activeEngineFeature.value === "connected_network" }, "tab-btn vos"])}" data-v-e9255cb5>🌐 Connected Networks Feature</button><button class="${ssrRenderClass([{ active: activeEngineFeature.value === "microfish" }, "tab-btn rstudio"])}" data-v-e9255cb5>🐠 Microfish Architecture Pipeline</button><button class="${ssrRenderClass([{ active: activeEngineFeature.value === "thematic_map" }, "tab-btn nvivo"])}" data-v-e9255cb5>🗺️ Thematic Strategic Map</button></div><div class="upload-box-premium" style="${ssrRenderStyle({ borderColor: activeEngineFeature.value === "connected_network" ? "#2980b9" : activeEngineFeature.value === "microfish" ? "#27ae60" : "#9c27b0" })}" data-v-e9255cb5><input type="file" multiple accept=".ris" class="file-input-hidden" data-v-e9255cb5><div class="upload-content" data-v-e9255cb5><span class="upload-icon" data-v-e9255cb5>📥</span><p class="upload-text" data-v-e9255cb5>Unggah kumpulan berkas hasil saringan PRISMA (Wajib format <strong data-v-e9255cb5>.RIS</strong> dari Scopus/Mendeley) </p><span class="upload-subtext" data-v-e9255cb5>Mesin akan mengekstrak data string asli pengetikan jurnal secara real-time.</span></div></div>`);
      if (uploadedFiles.value.length > 0) {
        _push(`<div class="file-list-box" data-v-e9255cb5><h4 data-v-e9255cb5>📂 Dokumen Terdeteksi di Workspace (${ssrInterpolate(uploadedFiles.value.length)} Files): </h4><div class="file-badges" data-v-e9255cb5><!--[-->`);
        ssrRenderList(uploadedFiles.value, (file, idx) => {
          _push(`<span class="badge-item" data-v-e9255cb5>📄 ${ssrInterpolate(file.name)}</span>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (activeEngineFeature.value === "connected_network" && networkPapers.value.length > 0 && !isProcessingFiles.value) {
        ...
        ssrRenderList(networkPapers.value, (paper, pIdx) => {
          _push(`<div class="cloud-tag" style="${ssrRenderStyle({ "display": "flex", "justify-content": "space-between", "align-items": "center", "border-radius": "8px", "padding": "15px", "background": "white", "border-left": "5px solid #2980b9", "margin": "0" })}" data-v-e9255cb5><div style="${ssrRenderStyle({ "text-align": "left", "max-width": "75%" })}" data-v-e9255cb5><span style="${ssrRenderStyle({ "font-size": "10px", "font-weight": "bold", "color": "#2980b9", "display": "block", "text-transform": "uppercase", "letter-spacing": "0.5px" })}" data-v-e9255cb5>${ssrInterpolate(paper.group)} • Map Affinity: ${ssrInterpolate(paper.connectivity)}</span><strong style="${ssrRenderStyle({ "font-size": "13.5px", "color": "#0f172a", "display": "block", "margin-top": "3px", "line-height": "1.4" })}" data-v-e9255cb5>${ssrInterpolate(paper.title)}</strong><span style="${ssrRenderStyle({ "font-size": "12px", "color": "#475569", "font-weight": "600", "display": "block", "margin-top": "2px" })}" data-v-e9255cb5>👤 ${ssrInterpolate(paper.author)}</span><div style="${ssrRenderStyle({ "margin-top": "8px", "display": "flex", "align-items": "center", "gap": "6px" })}" data-v-e9255cb5><span style="${ssrRenderStyle({ "font-size": "11px", "background": "#f1f5f9", "color": "#334155", "padding": "2px 6px", "border-radius": "4px", "font-family": "monospace" })}" data-v-e9255cb5>DOI: ${ssrInterpolate(paper.rawDoi)}</span>`);
          if (paper.doiUrl) {
            _push(`<a${ssrRenderAttr("href", paper.doiUrl)} target="_blank" style="${ssrRenderStyle({ "font-size": "11px", "color": "#2563eb", "font-weight": "bold", "text-decoration": "none", "display": "inline-flex", "align-items": "center", "gap": "2px" })}" data-v-e9255cb5> 🌐 CrossRef / Scopus Index Link ↗ </a>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div><div style="${ssrRenderStyle({ "background": "#e0f2fe", "color": "#0369a1", "font-size": "11px", "font-weight": "bold", "padding": "8px 14px", "border-radius": "6px", "white-space": "nowrap", "box-shadow": "0 1px 2px rgba(0,0,0,0.05)" })}" data-v-e9255cb5> 🔗 ${ssrInterpolate(paper.links)} Shared References </div></div>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      if (activeEngineFeature.value === "microfish" && microfishFramework.value && !isProcessingFiles.value) {
        _push(`<div class="visualizer-card" data-v-e9255cb5><h4 class="card-title text-rstudio" data-v-e9255cb5>Microfish Architecture Extraction Metric</h4><p class="card-subtitle" data-v-e9255cb5>Pembedahan granular parameter data, distribusi metodologi, serta integrasi skor validitas instrumen internal dokumen riset.</p><div style="${ssrRenderStyle({ "display": "grid", "grid-template-columns": "1fr 1fr", "gap": "20px", "margin-top": "15px" })}" data-v-e9255cb5><div style="${ssrRenderStyle({ "background": "#f0fdf4", "padding": "15px", "border-radius": "8px", "border": "1px solid #bbf7d0", "text-align": "left" })}" data-v-e9255cb5><div style="${ssrRenderStyle({ "font-size": "11px", "color": "#166534", "font-weight": "bold" })}" data-v-e9255cb5>🔬 EXTRACTED DATA VARIABLES (REAL STRING CAPTURE)</div><div style="${ssrRenderStyle({ "display": "flex", "flex-wrap": "wrap", "gap": "6px", "margin-top": "10px" })}" data-v-e9255cb5><!--[-->`);
...
Analisis visual cross-reference menunjukkan bahwa interkoneksi antar-referensi ini membentuk mata rantai konseptual yang solid, memotong kompas fragmentasi software tradisional dan mempermudah pemetaan kebaruan riset (novelty roadmapping).`;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "cross-ref-container" }, _attrs))} data-v-668997fe><div class="panel-header-badge-orange" data-v-668997fe>STEP 3</div><h3 class="section-title" data-v-668997fe>🌐 Connected Networks Evolution: Multi-Layer Visualizer</h3><p class="section-desc" data-v-668997fe>Menutup kelemahan Connected Papers. Modul ini tidak hanya memetakan prior &amp; derivative works dari file \`.RIS\` lokal Anda, tetapi juga **men-generate otomatis draf teks ulasan literatur** siap pakai.</p><div class="sub-tabs-container" data-v-668997fe><button class="${ssrRenderClass([{ active: activeSubTab.value === "prior_works" }, "sub-tab-btn"])}" data-v-668997fe>🌿 Prior &amp; Derivative Chronology</button><button class="${ssrRenderClass([{ active: activeSubTab.value === "synthesis_draft" }, "sub-tab-btn excel-color"])}" data-v-668997fe>✍️ AI Literature Review Synthesis Draft</button></div>`);
      if (activeSubTab.value === "prior_works") {
        ...
        if (!__props.parsedPapers || __props.parsedPapers.length === 0) {
          ...
          _push(`<div class="chronology-grid" data-v-668997fe><div class="chrono-card gray-edge" data-v-668997fe><h5 class="chrono-title" data-v-668997fe>👴 Prior Works Foundation (Fondasi Awal Riset)</h5><p class="chrono-desc" data-v-668997fe>Paper-paper yang paling banyak disitasi oleh koleksi Anda, bertindak sebagai basis teoretis utama.</p><!--[-->`);
          ssrRenderList(__props.parsedPapers.filter((p) => p.group === "Core Cluster").slice(0, 2), (paper, idx) => {
            _push(`<div class="paper-node-item" data-v-668997fe><strong data-v-668997fe>${ssrInterpolate(paper.title)}</strong><span data-v-668997fe>👤 Author: ${ssrInterpolate(paper.author)} | Link: <a${ssrRenderAttr("href", paper.doiUrl)} target="_blank" class="doi-link" data-v-668997fe>CrossRef ↗</a></span></div>`);
          });
          _push(`<!--]--></div><div class="chrono-card blue-edge" data-v-668997fe><h5 class="chrono-title" data-v-668997fe>🚀 Derivative Works (Akselerasi &amp; Kebaruan)</h5><p class="chrono-desc" data-v-668997fe>Paper turunan terbaru yang mencoba memperluas kerangka berpikir dari paper fondasi di sebelah kiri.</p><!--[-->`);
          ssrRenderList(__props.parsedPapers.filter((p) => p.group !== "Core Cluster").slice(0, 2), (paper, idx) => {
            _push(`<div class="paper-node-item-derivative" data-v-668997fe><strong data-v-668997fe>${ssrInterpolate(paper.title)}</strong><span data-v-668997fe>👤 Author: ${ssrInterpolate(paper.author)} | Affinity: <span class="badge-blue" data-v-668997fe>${ssrInterpolate(paper.connectivity)}</span></span></div>`);
          });
          _push(`<!--]--></div></div>`);
        }
        _push(`</div>`);
      ...
      if (activeSubTab.value === "synthesis_draft") {
        ...
        if (!__props.parsedPapers || __props.parsedPapers.length === 0) {
          ...
          if (isGeneratingDraft.value) {
            ...
            _push(`<div class="animate-fade-in" data-v-668997fe><div class="action-bar" data-v-668997fe><span data-v-668997fe>🔥 Draf Paragraf Hasil Sintesis Jurnal (Scopus-Ready Format)</span><button class="btn-refresh-draft" data-v-668997fe>🔄 Regenerate Draft</button></div><textarea readonly class="draft-textarea" data-v-668997fe>${ssrInterpolate(generatedDraftText.value)}</textarea><div class="copy-alert" data-v-668997fe>💡 <strong data-v-668997fe>Tips Sukses:</strong> Blok teks di atas, tekan <code data-v-668997fe>Ctrl + C</code>, lalu tempelkan langsung ke bab 2 (Literature Review) draf paper Scopus Anda!</div></div>`);
          }
          _push(`</div>`);
        }
        _push(`</div>`);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-dashboard" }, _attrs))}><header class="main-header"><h1 class="main-title">🔬 SLR &amp; Bibliometric Disruptive Engine</h1><p class="main-subtitle">Memotong Kompas Kompleksitas Riset: Solusi Instan untuk Automasi PRISMA &amp; Visualisasi Matriks Tanpa Fragmentasi Software.</p></header><section class="value-prop-box"><strong>💡 Menjawab Keresahan Dunia Penelitian Akademik Saat Ini:</strong> Melakukan analisis bibliometrik dan SLR selama ini sangat melelahkan karena peneliti dipaksa menguasai banyak software yang terfragmentasi. Platform ini hadir untuk mendisrupsi tantangan tersebut! Cukup unggah berkas diagram PRISMA atau seret puluhan file .RIS/.BIB/CSV Anda ke sistem, AI akan langsung merumuskan analisis konseptual komprehensif Scopus-Ready di satu halaman terpadu. </section>`);
...
//# sourceMappingURL=index-CZqPPhMN.js.map
